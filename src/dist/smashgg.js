...
var NI = __importStar(require("./util/NetworkInterface"));
...
(function (IEvent) {
    ...
    function getDefaultData() {
        return {
            tournament: internal_2.ITournament.getDefaultData(),
...
var Event = /** @class */ (function () {
    ...
    Event.prototype.getEventPhases = function () {
        if (this.data.entities.phase) {
            ...
            return new Promise(function (resolve, reject) {
                var promises = [];
                if (_this_1.data.entities.phase) {
                    promises = _this_1.data.entities.phase.map(function (p) {
                        return internal_1.Phase.get(p.id);
                    });
                }
...
var GGSet = /** @class */ (function () {
    function GGSet(id, eventId, round, isComplete, data, winner, loser, score1, score2, winnerId, loserId) {
        ...
        if (winner != undefined && !(winner instanceof internal_1.Player))
            throw new Error('Winner Player for Set cannot be null, and must be an instance of ggPlayer');
        if (loser != undefined && !(loser instanceof internal_1.Player))
    ...
    GGSet.resolve = function (data) {
        return new Promise(function (resolve, reject) {
            ...
            internal_1.Player.getFromIdArray(playerIds)
    ...
    GGSet.get = function (id) {
        ...
        return NI.request('POST', Common_1.API_URL, postParams)
            .then(function (data) {
...
var PhaseGroup = /** @class */ (function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this.data.entities.entrants) {
                _this.data.entities.entrants.forEach(function (entrant) {
                    var P = internal_1.Player.resolve(entrant);
                    players.push(P);
                });
            }
            return resolve(players);
    ...
    PhaseGroup.prototype.getSets = function () {
        return this.getMatchIds()
            .then(function (ids) {
            return internal_1.GGSet.getFromIdArray(ids);
        });
    };
...
var Tournament = /** @class */ (function () {
    ...
    Tournament.get = function (tournamentName, expands) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var expandsString = Common_1.createExpandsString(expands);
            var postParams = {
                type: 'tournament',
                tournamentName: tournamentName,
                expands: expands
    ...
    Tournament.prototype.getAllEvents = function () {
        if (this.data.entities.event) {
            ...
            this.data.entities.event.forEach(function (event) {
                promises_1.push(internal_1.Event.get(_this_1.name, event.name));
            });
    ...
    Tournament.prototype.getAllSets = function () {
        if (this.data.entities.groups) {
            ...
            groups.forEach(function (group) {
                promises_2.push(internal_1.PhaseGroup.get(group.id));
            });
            return Promise.all(promises_2)
                ...
                return Common_1.flatten(allSets);
            });
        }
        else
    ...
    Tournament.prototype.getAllPlayers = function () {
        if (this.data.entities.groups) {
            ...
            return Promise.all(groupPromises)
                ...
                .then(function (players) {
                return Common_1.flatten(players);
            });
        }
        else
...
var smashgg = {
    ...
    Event: Event_1.Event,
    Phase: Phase_1.Phase,
    PhaseGroup: PhaseGroup_1.PhaseGroup,
    GGSet: GGSet_1.GGSet,
    Player: Player_1.Player
};
exports["default"] = smashgg;
